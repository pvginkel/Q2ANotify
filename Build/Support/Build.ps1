...
Function Create-Setup
{
    ...
    $Target = $Global:Distrib + "\Q2ANotify Setup.exe"
    $Site = "http://nuget.org/api/v2"
    $PackageCode = "Q2ANotify"
    $SetupTitle = "Q2A Notify"
    
    $Header = $Global:Root + "\Build\Support\header.sfx"
    $Payload = $Global:Root + "\Build\Support\ngubs.7z"
...
Build-Solution -Solution ($Global:Root + "\Q2ANotify.sln") -Platform "Any CPU"
